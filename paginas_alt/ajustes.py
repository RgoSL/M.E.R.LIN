...
from func_visual.widgets.progress import progress_bar  # Importando a barra de progresso
...
class ajustes(CTkFrame):
    def __init__(self, master, controller):
        ...
        # --- Termos de Uso --- (removido os outros labels)
    ...
    # --- Atualiza o label de informações --- (removido a função que atualizava o texto)
    def atualizar_info_label(self):
        pass  # A função foi removida, pois não será mais necessária.
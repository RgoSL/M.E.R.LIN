...
class config(CTkFrame):
    def __init__(self, master, controller):
        ...
        # Botões
        btn_voltar = CTkButton(self, text="Voltar", font=("Bold", 15), text_color="white",bg_color="transparent" ,fg_color="#654E82",corner_radius=10, command=lambda: controller.mostrar_pagina("idioma_software"), hover=False)
        
        btn_proximo = CTkButton(self, text="Proximo",  font=("Bold", 15), text_color="white",bg_color="transparent" ,fg_color="#654E82",corner_radius=10,command=lambda: controller.mostrar_pagina("ajustes"), hover=False)

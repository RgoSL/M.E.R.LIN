...
class ajustes(CTkFrame):
    def __init__(self, master, controller):
            ...
            OptionMenu1.place(relx=0.66, rely=0.3, anchor=CENTER, relwidth=0.2, relheight=0.1)
            ...
            OptionMenu2.place(relx=0.66, rely=0.5, anchor=CENTER, relwidth=0.2, relheight=0.1)
            ...
            OptionMenu3.place(relx=0.784, rely=0.3, anchor=CENTER, relwidth=0.2, relheight=0.1)
            ...
            OptionMenu4.place(relx=0.784, rely=0.5, anchor=CENTER, relwidth=0.2, relheight=0.1)
            ...
            OptionMenu5.place(relx=0.47, rely=0.3, anchor=CENTER, relwidth=0.2, relheight=0.1)
            ...
            OptionMenu6.place(relx=0.47, rely=0.5, anchor=CENTER, relwidth=0.2, relheight=0.1)

            camera = CTkLabel(frame2, text="Câmera", font=("Arial", 15), text_color="#E6C8FA")
            camera.place(relx=0.3, rely=0.26, anchor=CENTER)

            lingua = CTkLabel(frame2, text="Língua", font=("Arial", 15), text_color="#E6C8FA")
            lingua.place(relx=0.3, rely=0.46, anchor=CENTER)
            ...
            btn_voltar = CTkButton(frame, text="Voltar", font=("Arial", 15), text_color="black", fg_color="#654E82", command=lambda: controller.mostrar_pagina("config"))
            btn_voltar.place(relx=0.09, rely=0.15, anchor=CENTER, relwidth=0.07, relheight=0.06)
